//Вариант 14. Дан набор целых чисел с четным количеством элементов.
//1. Заполнить вектор V исходными числами и вывести вторую половину элементов вектора V в обратном порядке, а затем — первую
//половину в обратном порядке.
//2. Вставить перед третьим с конца элементом вектора последние
//5 элементов вектора в обратном порядке.
//3. Переместить средний элемент вектора в конец.
//4. Удвоить значения в последней паре соседних совпадающих элементов.
